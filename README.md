...
이 3단 구조와 패딩 값은 피그마 그리드 시스템으로 먼저 설계했습니다. 뷰포트 프레임(전체 너비) 안에 배경을 담당하는 섹션 프레임을 두고, 그 안에 콘텐츠 프레임을 Fill·최대 너비 제약으로 배치하는 구조로 잡았고, 그리드는 모바일 마진 16·거터 16, 데스크탑은 1440px 안에서 거터 24px인 12컬럼을 기준으로 삼았습니다.
