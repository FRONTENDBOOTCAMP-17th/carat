...
금속과 보석에 각각 PBR 재질을 입힌 뒤 glTF(`.glb`)로 내보냈습니다. 톤매핑은 ACES 대신 **Khronos PBR Neutral**을 선택했는데, ACES를 사용했을 땐 스톤과 메탈 특유의 강한 대비가 시각적으로 약해져 임팩트가 사라졌기 때문입니다. Neutral로 그 대비를 살려 주얼리다운 광택을 유지했습니다.
